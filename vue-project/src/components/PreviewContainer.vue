...
export default {
    computed: {
        ...
        contentStyle(){
            ...
            return {
                marginLeft: container.marginX + 'px',
                marginRight: container.marginX + 'px',
                marginTop: container.marginY + 'px',
                marginBottom: container.marginY + 'px',
                paddingLeft: container.paddingX + 'px',
                paddingRight: container.paddingX + 'px',
                paddingTop: container.paddingY + 'px',
                paddingBottom: container.paddingY + 'px',
...
<template>
    <div class="mockup-window" :style="barStyle">
        <label class="btn btn-sm glass swap swap-rotate absolute top-2 right-5">
            <input type="checkbox" @change="$event => isdarkmodeStore.changeDarkmode()" />
